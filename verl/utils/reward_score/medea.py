...
def validate_label(data_str, ground_truth):
...
def compute_score(solution_str, ground_truth, extra_info):
    try:
        ...
        print(f"[MEDEA] completion: \n", solution_str)
        print(f"[MEDEA] ground_truth: \n", ground_truth)
        print(f"[MEDEA] extra_info: \n", extra_info)
        print(f"[MEDEA] Error: {e}")


def compute_score_inner(solution_str, ground_truth, extra_info):
    logger = LogCollector(prefix="MEDEA")
    logger.clear()
    ...
    if format_correct and answer_text:
        ...
        answer_score = validate_label(answer_text.strip(), extra_info['ground_truth'].strip())
    else:
        pass
